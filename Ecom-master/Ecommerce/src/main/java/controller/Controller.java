...
public class Controller extends HttpServlet 
{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		if(page.equals("women") || page.equals("men")) 
		{
			DB db = new DB();
			...
			if(page.equals("women"))
				request.getRequestDispatcher("womens.jsp").forward(request, response);
			if(page.equals("men"))
				request.getRequestDispatcher("mens.jsp").forward(request, response);
		...
		if(page.equals("addtocart")) 
		{
			...
			JOptionPane.showMessageDialog(null, "Product successfully added to Cart..."
					+ "( Please log in to see the cart! )", "Info", JOptionPane.INFORMATION_MESSAGE);
			}
